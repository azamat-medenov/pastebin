...
async def test_create_user(
    ac: AsyncClient, create_user_schema: UserCreateDTO, erase_users
):
    response = await ac.post("/users", json={**create_user_schema.model_dump()})
...
async def test_login(ac: AsyncClient, create_user_schema: UserCreateDTO, erase_users):
